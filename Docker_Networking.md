...
If you want to secure your containers and isolate them from the default bridge network you can also create your own bridge network with whatever name.
...
NETWORK ID          NAME                DRIVER
xxxxxxxxxxxx        bridge              bridge
xxxxxxxxxxxx        <network name>      bridge
xxxxxxxxxxxx        none                null
xxxxxxxxxxxx        host                host
```
